...
assert.match(edge, /body\.action === "commonsPhotoCategories"/);
assert.match(edge, /body\.action === "commonsCategoryPhotos"/);
...
assert.match(page, /searchCommonsPhotos\(commonsQuery, commonsNextBatchToken\)/);
assert.match(client, /action: "commonsPhotoSearch"/);
assert.match(client, /nextOffset/);
assert.match(page, /setCommonsNextBatchToken/);
