...
- V3.6.1「Android 記帳金額欄位與 PWA 更新流程修正」已於 2026-09-01 合併至 `main`、建立 `v3.6.1` tag 並部署。Android 手機已驗證更新提示一次點擊即可完成，記帳金額輸入欄位不再變形或超出畫面；更新後介面顯示偏慢已由 V3.6.5 發布候選完成改善。
...
- V3.6.5「PWA 更新後介面顯示效能改善」已完成發布候選實作、同機 V3.6.4／V3.6.5 各五次桌面量測、全部自動驗證與暫時量測移除；候選採一般更新，實體裝置與正式發布待完成。
