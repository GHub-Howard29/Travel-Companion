...
- [ ] V3.9.1 地點／照片介面：Google Maps 連結維持另開分頁，文案改為「在 Google Maps 查看地點資訊」；MAP 候選不理想時增加更換關鍵字提示；Commons 每批候選由 8 張改為 6 張，前後端分頁、去重、測試及桌面／390×844 必須同步驗證。MAP 提示完整文案仍待 Product Owner 確認，不得先行實作。
