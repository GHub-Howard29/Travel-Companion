...
- [ ] V3.9.11：依《[63_V3.9.11_Commons候選照片數量與取樣改善計畫](63_V3.9.11_Commons候選照片數量與取樣改善計畫.md)》擴大 Commons 候選取樣並分為精準／需人工確認兩層；移除 QID 範圍選擇、候選不足時隱藏換批，並規劃修正自行上傳誤報讀取失敗與卡片來源備註。程式實作前先完成 UI 文案與桌面／手機預覽核准。
