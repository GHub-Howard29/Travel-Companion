...
>
> V3.6.1 已完成 Android Chrome／PWA 記帳金額欄位與 PWA 更新流程的程式修正，Product Owner 已於 2026-09-01 進入手動發布程序；正式發布完成前，最新發布與程式版本現況仍維持 V3.6.0。其後為 V3.6.2 行程天數縮短刪除確認與歷史行程全面鎖定，再進入 V3.7.0「當日後續行程時間連動調整」。
>
> 最後更新：2026-09-01
