...
>
> V3.9.5 為目前發布候選，合併原 V3.9.4 的照片功能與原 V3.9.5 的行程修正；V3.9.4 不獨立發布。完整非互動本機回歸及 production build 已通過；依 2026-09-18 決定不執行互動驗證，未執行 production 變更。
>
> 最後更新：2026-09-18
...
- [V3.9.5／V3.9.4 合併發布候選紀錄](58_V3.9.5_V3.9.4合併發布候選紀錄.md)
