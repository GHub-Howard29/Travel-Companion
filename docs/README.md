...
>
> 最新發布：V3.5.4「管理者名稱映射與 Trip 建立防護」（2026-08-27；採非強制更新）
>
> V3.5.4 已完成正式 Supabase migration、資料庫角色回歸、Super Admin 介面驗收、合併、tag、部署及全部保留實機驗證；V3.5.5 候選實作與電腦版驗證完成、待手動發布；V3.5.6 已規劃版本更新最低支援版本機制。
>
> 最後更新：2026-08-27
...
- [V3.5.6 版本更新最低支援版本機制](20_V3.5.6_版本更新最低支援版本機制.md)
