...
>
> V3.6.1 已完成 Android Chrome／PWA 記帳金額欄位與 PWA 更新流程的程式修正，Product Owner 已於 2026-09-01 進入手動發布程序；發布候選 App build 與公開 metadata 已設定為 V3.6.1，正式發布完成前的最新已發布版本仍為 V3.6.0。其後為 V3.6.2 行程天數縮短刪除確認與歷史行程全面鎖定，再進入 V3.7.0「當日後續行程時間連動調整」。
>
> 最後更新：2026-09-01
