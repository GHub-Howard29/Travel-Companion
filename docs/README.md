...
>
> V3.6.3 發布狀態為「已發布」；Git 版本標籤為 `v3.6.3`，正式 metadata 與部署資產已驗證。桌面、Android 與登入後管理者流程均已通過；僅 iOS Safari／standalone PWA 的更新提示、版本資訊、交通圖示及縮短天數雙階段確認保留補驗；後續依序為 V3.6.4、V3.6.5 與 V3.7.0。
>
> 最後更新：2026-09-03
