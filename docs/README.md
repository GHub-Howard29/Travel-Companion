...
>
> 最新發布：V3.6.1「Android 記帳金額欄位與 PWA 更新流程修正」（2026-09-01；已完成合併、tag、部署及 Android 手機實機驗證）
>
> V3.6.2「行程天數縮短刪除與歷史行程全面鎖定」已完成開發並準備由 Product Owner 手動發布；正式發布狀態等待部署完成後回報。其後進入 V3.7.0「當日後續行程時間連動調整」。V3.6.1 更新後介面重新顯示的體感速度偏慢，已列為發布後效能檢查。
>
> 最後更新：2026-09-01
